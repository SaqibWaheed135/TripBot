...
const SelectTraveller = () => {
  ...
  useEffect(() => {
    if (selectedTraveler) {
      setTripData({ ...tripData, travelCount: selectedTraveler })
    }
  }, [selectedTraveler])
      ...
      >
        <SafeAreaView style={styles.container}>
          ...
          >
            ...
            <Text style={styles.mainTitle}>Who's Travelling?</Text>
            <Text style={styles.subtitle}>
              Choose your travel companions for the perfect experience
            </Text>
          </Animated.View>
          ...
          >
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>Select Travellers</Text>
